...
if __name__ == "__main__":
    ...
    input_data = dga.get_model_data(path_input)
    solution_data = dp.import_pie_solution(path_solution, path_input)
    ...
    schedule = solution.get_schedule(instance.compare_tups)
    pp.pprint(schedule)
