...
# compare latex:
# latexdiff --config="PICTUREENV=(?:picture|DIFnomarkup|align|figure|table)[\w\d*@]*" zzzmanuscript_old.tex zzzmanuscript_new.tex > zzztmpdiff.tex
# latexdiff --config="PICTUREENV=(?:picture|DIFnomarkup|figure)[\w\d*@]*" zzzmanuscript_old.tex zzzmanuscript_new.tex > zzztmpdiff.tex
# latexdiff zzzmanuscript_old.tex zzzmanuscript_new.tex > tmpdiff.tex
# latexdiff --config="PICTUREENV=(?:picture|DIFnomarkup|figure)[\w\d*@]*" zzzmanuscript_old.tex zzzmanuscript_new.tex > tmpdiff.tex
#
