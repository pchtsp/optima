...
################# manual alternative...
# exp_list = ['IT000125_20190808', 'IT000125_20190729']
# df = compare_sto.get_df_comparison(exp_list)
# df = df[df.scenario == 'numparalleltasks_2']

exp_list = ['IT000125_20190808', 'IT000125_20190812']
df = compare_sto.get_df_comparison(exp_list).reset_index()
# df = df[df.scenario == 'numparalleltasks_3']
df = df.query("scenario == 'numparalleltasks_3' or experiment==1")
################# manual alternative...
