...
.center[
**Predicting *when* aircraft will need a maintenance**.
]
--

* This is not what we do.
* We make maintenance plans for the whole fleet, taking into account maintenance needs.
* So, we use this data to make better maintenance plans.
* Nevertheless, we will predict *something* during this presentation.
...
good model + good solver = solution.
