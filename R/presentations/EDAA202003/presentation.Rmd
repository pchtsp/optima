...
* The objective is to **minimize the total number of checks** while **maximizing the status of the fleet** at the each period of the horizon.
...
$m_{it_1t_2}$: aircraft $i$ starts a check in $t_1$ and another check in $t_2$.
...
1. Train a statistical model to predict characteristics of good (optimal?) solutions for any given instance.
2. Use this information to limit the solution space and make it easier to find those potentially good solutions.

--

**Benefits**:

1. **Performance**: a smaller problem is easier to solve.
...
**The better we're able to predict those characteristics for the whole fleet, the less optimality we will lose**
...
* **Dasault Aviation**: desktop software OPTIMA built, tested, deployed and validated by users.

*Estimated thesis defense: Novembre 2020.*
