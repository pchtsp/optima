...
Instances have been generated with the following main characteristics:
...
* Medium instances have **80.000 variables** and **50.000 constraints**.
* Runs of 30 minutes have been done on 30 randomly generated cases per scenario and they return a gap between 20% and 40% if a solution exists.
...
* `r infeasible[1]`% of instances were proved infeasible inmediately.
* From feasible small instances, a gap of `r scen_means[1]`% was found after 30 min
* From feasible medium instances, a gap of `r scen_means[2]`% was found after 30 min.

## Perspectives

* More extreme (bigger) scenarios need to be tested: more tasks and more resources.
* A deeper analysis on the detailed solving process is envisioned. Including extending the solving time.
* Benchmarking of solvers (gurobi, CBC, choco and CPO) is work in progress. Also: heuristics.
* The inclusion of new possibilities, such as the planned storage of resources is pending.
* A stochastic sensibility analysis needs to be done, including taking account of stochasticity in the input data.
