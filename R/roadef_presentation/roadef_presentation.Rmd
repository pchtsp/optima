...
* In @Cho2011, US Army aircraft were assigned daily operations over a year to aircraft.
* In @Kozanidis2008, Greek aircraft had monthly assignments of maintenances and flight hours. 
* In @Verhoeff2015, monthly assignments were done and several objectives were taken into account: availability, serviceability and sustainability.
...
Elapsed times are treated in the same way but consumption is always 1.
\begin{align}
...
Visualization of each constraints for one resource.
...
* Analysis for all instances: not many pareto optimal points available.
* Between 2 and 4 for all instances
* The objectives are quite aligned one with the other.

## Next steps

* **Try different objectives**: availability and maintenances.
