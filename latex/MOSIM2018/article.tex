...
\section{Datasets}
  ...
  Based on the information provided, a number of instances were created as subsets of the main dataset in order to run different experiments. The criteria for the creation of the instances was the following:
    ...
    \begin{enumerate}
        ...
        \item Take out the task with the biggest number of required resources.
        \item Increase the number of periods in multiples of 10 until no integer solutions can be found in 3600 seconds.
        \item Repeat step 2.
    \end{enumerate}
...
\section{Results}
  ...
  \caption{Comparison of instances where variations on the weight of its two objectives has been done. Instance I\_1. All experiments were solved to optimality.}
  \vspace{-0.5cm}
  \label{tab:multiobj}
  \end{center}
  \end{table}
  ...
  \begin{figure}
    ...
    \caption{Pareto diagram comparing the quality of both objectives for each instance. Instance id=I\_1.}
    \label{fig:pareto}
  \end{figure}
