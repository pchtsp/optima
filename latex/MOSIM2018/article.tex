...
{\bf  ABSTRACT:}
\rm
{\em A specific Flight and Maintenance Planning problem is presented in this. 
...
\section{Introduction}
  ...
  Flight and Maintenance Planning (FMP) problems raise civilian or military operational applications. 
...
\section{Problem statement}
  ...
  \subsection{Tasks}
    ...
    Each task requires one and only one type of resource which should comply with task requirements.
  ...
  \subsection{Resources}
    ...
    At any given period, including at the start of the planning horizon, each resources has a specific status given by remaining usage time and remaining elapsed time.
...
\section{Related work}
  ...
  The use of aggregate demand makes it impossible to optimize the task assignments for aircraft.
...
\section{Datasets}
  ...
  \subsection{Tasks}
    ...
    Candidates resources are calculated based on each task's requirements matching the candidate's capabilities.
  ...
  \subsection{Maintenances}
    ...
    All maintenance operations last exactly 6 periods. Each maintenance provides with 1000 hours of usage time to the resource. After it, a resource can be without maintenance for a maximum of 60 consecutive periods. The nominative capacity for maintenance is 18 resources at any given time.

  \subsection{Resources}

    There are 127 resources in total. Each one has its functionalities and past assignments.
...
\section{Results}
  ...
  \label{sec:multi}
    ...
    Table \ref{tab:multmultiobj} presents the obtained results of this analysis. It can be seen that all instances have a small number of Pareto optimal solutions.
    ...
    \caption{Non-dominated points found on each instance after 3600 seconds. All instances were analyzed. "First" and "Last" indicate the two extremes of the Pareto frontier. "\# points" indicates the number of Pareto optimal points found. Not all experiments were solved up to optimality.}
    \vspace{-0.5cm}
...
\section{Conclusions and further work}
  ...
  The first one to smooth maintenance operations and the second one to aircraft availability.
