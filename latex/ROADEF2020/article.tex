...
\author{Franco Peschiera\inst{1}, Alain Ha{\"i}t\inst{1}, Olga Batta{\"i}a\inst{1}, Nicolas Dupin\inst{2}}


\institute{
ISAE-SUPAERO, Universit{\'e} de Toulouse, France \\
\email{\{franco.peschiera,alain.hait,olga.battaia\}@isae-supaero.fr}\\
