...
\subsection{Input data}
    ...
    \subsubsection{Parametric sets}
        ...
        \begin{tabular}{p{15mm}p{140mm}}
            ...
            $j \in \mathcal{JK}_k$     &  missions $j \in \mathcal{I}$ that are included in cluster $k$. One mission can only belong to one cluster. \\
    ...
    \begin{align}
        ...
        & H^{Clust}_{k} = \sum_{j \in \mathcal{JK}_k} H_j
    \end{align}
...
\subsection{Variables}
    ...
    \begin{tabular}{p{8mm}p{147mm}}
        ...
        $e^{H}_{ks}$ & Continuous, positive. Elastic variable for sustainability constraint (\ref{eq:sustainability-cluster}). \\
