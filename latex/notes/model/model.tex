...
\subsection{Variables}
    ...
    \begin{tabular}{p{8mm}p{117mm}}
        $a_{ijtt'}$ &  =1 if aircraft $i$ starts a new assignment to mission $j$ in period $t$ and finishes it at period $t'$. \\  
        $m_{itt'}$  &  =1 if aircraft $i \in I$ starts a check in period $t \in \mathcal{T}$ and then starts the next one at period $t'$, 0 otherwise. \\
    \end{tabular}
