...
\section{Mathematical model}
    ...
    \begin{tabular}{p{15mm}lp{105mm}}
        ...
        $rut_{it}$          & = & remaining usage time (continous) for resource $i$ after period $t \in \mathcal{T}_0$. \\  
